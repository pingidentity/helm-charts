...
#     (echo "$branch" | grep -Eq ^\d.\d.\d$) && echo "Release version passed formatting check, proceeding to GitHub push..." || echo "Release version DID NOT pass format check..." && exit 1
